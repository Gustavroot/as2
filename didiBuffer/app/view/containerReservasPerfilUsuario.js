        ...
        items: [
            ...
            },
            {
                ...
                itemTpl: [
                    ...
                    '        <td>',
                    '            <font size="3">',
                    '            <p style="color:black;">En: {idCliente}</p>',
                    '            <p style="color:black;">Fecha: {fechaReserva}</p>',
                    '            </font>',
                    '        </td>',
                    '        <td align=right>',
                    '            <input type="button" id="botonVerDetallesReservaPerfilUsuario" class="botonCancelarReserva" name="" value="Detalles" style="padding:3px; color:green; height:30px; width: 100%;">',
                    '            <input type="button" id="botonVerCancelarReservaPerfilUsuario" class="botonCancelarReserva" name="" value="Cancelar" style="padding:3px; color:green; height:35px; width: 100%;">',
                    '         </td>',
                    '    </tr>',
                    '</table>',
                    '</div>',
