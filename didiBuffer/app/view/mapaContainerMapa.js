        ...
        if(dato.tipoPlan<4){
            ...
            serviceCalculoDistanciasMapaPrincipal.getDistanceMatrix(
            {
                ...
                google.maps.event.addListener(marker, "click", function() {
                    ...
                    infoWindow.setContent("<center><p>"+dato.nombre+"</p></center><p><input "+stringParaAgregarFuncionPrimerBoton+" type='button' id='botonParaInfoWindow' value='Ir a descripción' style='font-size: 100%; font-family: texgyrechorus; background-color:#A9F5BC; padding:3px; color:green; height:10%; width: 70%;'></p> <p><input "+stringParaAgregarFuncionSegundoBoton+" type='button' id='botonParaInfoWindow2' value='Llamar' style='font-size: 100%; font-family: texgyrechorus; background-color:#A9F5BC; padding:3px; color:green; height:10%; width: 70%;'></p>"+"<p><input "+stringParaAgregarFuncionBotonIrMapaPrincipal+" type='button' id='botonParaIrMapaPrincipal' value='Ir' style='background-color:#A9F5BC; padding:3px; color:green; height:10%; width: 90%;'></p>"+"<p> Distancia: "+distanciasHastaEmpresa[dato.idCliente]+"</p>"+"<p> Duracion: "+duracionesHastaEmpresas[dato.idCliente]+"</p>");
